...
class MMDistributedDataParallel(DistributedDataParallel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # --- PATCH START ---
        # Safe patch for PyTorch >= 2.4:
        # In newer versions of PyTorch, the attribute `_use_replicated_tensor_module`
        # may not be initialized on certain modules before pickling/distributed training.
        # This check ensures backward compatibility by explicitly setting it to `False`
        # if it does not already exist, preventing attribute errors during runtime.
